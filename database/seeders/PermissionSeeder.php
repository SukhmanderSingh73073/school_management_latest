...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ["guard_name"  => 'web', 'name' => 'menu-staff-manager'],
            ...
            ["guard_name"  => 'web', 'name' => 'menu-school',],
            ...
            ["guard_name"  => 'web', 'name' => 'read permission-school',],
            ["guard_name"  => 'web', 'name' => 'create permission-school',],
            ["guard_name"  => 'web', 'name' => 'update permission-school',],
            ["guard_name"  => 'web', 'name' => 'delete permission-school',],
            ...
            ["guard_name"  => 'web', 'name' => 'read self-student-attendance',],
            ["guard_name"  => 'web', 'name' => 'edit self-student-attendance',],
            ["guard_name"  => 'web', 'name' => 'create self-student-attendance',],
            ["guard_name"  => 'web', 'name' => 'delete self-student-attendance',],
            ...
            // COLUMN MANAGMENT
            ["guard_name"  => 'web', 'name' => 'menu-column'],
            ["guard_name"  => 'web', 'name' => 'read column-school'],
        ];
        ...
        $super_admin->givePermissionTo([
            ...
            'delete staff-teacher',
                ...
                // assign permission to super-admin1
                $super_admin = Role::where('name', 'super-admin1')->first();
                $super_admin->givePermissionTo([
                    'menu-staff',
                    'menu-teacher',
                    'menu-school',
